...
class Banco:
    ...
    def _checa_se_conta_do_cliente(self, cliente, conta):
        if conta is cliente.conta:
            print("_checa_se_conta_do_cliente", True)
            return True
        print("_checa_se_conta_do_cliente", False)
        return False
    ...
    def autenticar(self, cliente, conta):
        return (
            ...
            and self._checa_se_conta_do_cliente(cliente, conta)
        )
